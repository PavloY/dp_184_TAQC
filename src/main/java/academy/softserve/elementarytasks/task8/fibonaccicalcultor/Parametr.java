...
public final class Parametr {
    ...
    public static final String ENTER_UPPER = "Enter upper range:";
    public static final String ENTER_LENGTH = "Enter length:";
    public static final String SHOW_ERROR = "Incorrect input: You should enter only integers (1 or 2), please try again!";
